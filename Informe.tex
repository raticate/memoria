...
Usando una versioń simplificada del método BGW \todo{falta cita, falta explicación de BGW}, los nodos calculan $N = (p_1 + p_2 + \ldots + p_k)\cdot(q_1 + q_2 + \ldots + q_k)$. Al final de este paso, $N$ es público.
